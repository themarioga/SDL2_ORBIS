...
/* ORBIS isn't that sophisticated */
...
/* !!! FIXME: what does ORBIS do for filesystem stuff? */
#define SDL_FILESYSTEM_DUMMY   1

/* ORBIS doesn't have haptic device (src/haptic/dummy/\*.c) */
#define SDL_HAPTIC_DISABLED    1

/* ORBIS can't load shared object (src/loadso/dummy/\*.c) */
